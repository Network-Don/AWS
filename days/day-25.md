...
![S3 Bucket Configuration](../Week-05/Day%2005/Step%201%20-%20S3%20bucket%20with%20versioning%20+%20encryption%20+%20tags%20enabled.png)
...
![Folder Prefix Structure](../Week-05/Day%2005/Step%202%20-%20Objects%20organised%20in%203%20prefix%20folders.png)
*Viewing the simulated folders (contracts, correspondence, filings) in the AWS S3 Console.*

---

### Lifecycle Rules Configuration
![S3 Lifecycle Rules](../Week-05/Day%2005/Step%203%20-%20Lifecycle%20rule%20configured%20with%20all%20transitions.png)
...
![Working Pre-Signed URL](../Week-05/Day%2005/Step%204%20-%20Pre-Signed%20URL%20working%20in%20browser%20%28file%20downloads%29.png)
...
| [« Previous Day: S3 Cross-Region Replication (CRR)](./day-24.md) | [Next Day: N/A »](../README.md) |
| :---: | :---: |
