...
![S3 bucket with versioning enabled](./Step%201%20-%20S3%20bucket%20with%20versioning%20enabled.png)
*Configuring the S3 bucket properties tab to enable versioning.*

---

### Object Version History
![Show versions toggle showing all 3 versions of my file](./Step%202%20-%20Show%20versions%20toggle%20showing%20all%203%20versions%20of%20my%20file.png)
...
![File disappears after delete (delete marker added)](./Step%203%20-%20File%20disappears%20after%20delete%20%28delete%20marker%20added%29.png)
*Deleting the object under normal view, resulting in the creation of a Delete Marker at the top of the version stack.*

---

### Object Restoration
![File restored after removing delete marker](./Step%204%20-%20File%20restored%20after%20removing%20delete%20marker.png)
...
![File properties showing SSE-S3 encryption](./Step%205%20-%20File%20properties%20showing%20SSE-S3%20encryption.png)
...
![Bucket policy applied in console](./Step%206%20-%20Bucket%20policy%20applied%20in%20console.png)
...
| [« Previous Day: S3 Storage Classes & Lifecycle](../Day%2002/README.md) | [Next Day: N/A »](../../README.md) |
| :---: | :---: |
