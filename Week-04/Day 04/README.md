...
![Auto Scaling Group showing 2 running instances](./Auto%20Scaling%20Group%20showing%202%20running%20instances.png)

---

### Load Balancer Active State
![Load Balancer Active State](./Load%20Balancer%20showing%20Active%20state.png)

---

### Dynamic Load Balancing (Served from Different Hostnames)
![Dynamic Traffic Distribution](./Browser%20showing%20traffic%20from%20different%20hostnames.png)

---

### Auto Scaling Group Activity History
![ASG Activity History](./ASG%20activity%20history.png)

---

### Target Group Healthy Instances
![Target Group Healthy Instances](./Target%20Group%20healthy%20instances.png)

---

### Lab Cleanup
![Lab Cleanup](./Cleanup%20screenshots.png)
